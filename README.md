...
2. Navigate to the Connect Calendar flow
3. Enter your city in the location input
4. Generate your calendar file with simulated weather data
5. Copy the .ics link to import into your calendar app
...
Edit `src/i18n/routing.ts` to modify supported locales:

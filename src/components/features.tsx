...
const BackgroundGradients = (
    <>
        <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 blur-[120px] opacity-15 pointer-events-none">
            <div className="aspect-square h-[600px] rounded-full bg-gradient-to-br from-purple-500/50 via-indigo-500/30 to-transparent" />
        </div>
        <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/4 blur-[120px] opacity-15 pointer-events-none">
            <div className="aspect-square h-[600px] rounded-full bg-gradient-to-tr from-blue-500/50 via-cyan-500/30 to-transparent" />
        </div>
    </>
);
